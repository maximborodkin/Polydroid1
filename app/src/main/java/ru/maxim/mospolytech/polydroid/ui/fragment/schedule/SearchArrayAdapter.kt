...
class SearchArrayAdapter(context: Context, items: List<SearchObject>) : ArrayAdapter<SearchObject>(context, 0, ArrayList()) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val icon = when(item?.getType()){
            ScheduleType.Group -> R.drawable.ic_group_gray_24dp
            ScheduleType.Teacher -> R.drawable.ic_teacher_gray_24dp
            ScheduleType.Classroom -> R.drawable.ic_door_gray_24dp
            null -> 0
        }
